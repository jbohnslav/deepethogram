...
def simple_popup_question(parent, message: str):
    ...
    reply = QtWidgets.QMessageBox.question(
        parent, "Message", message, QtWidgets.QMessageBox.Yes, QtWidgets.QMessageBox.No
    )
...
def overwrite_or_not(parent):
    ...
    msgBox.setText(
        "Do you want to overwrite your labels with these predictions, or only import the predictions"
        " for frames you haven"
        "t labeled?"
    )
